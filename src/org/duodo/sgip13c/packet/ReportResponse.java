 ...
 *
 */
public enum ReportResponse implements PacketStructure {
    ...
    private ReportResponse(SgipDataType dataType, boolean isFixFiledLength, int length) {
    	this.length = length;
	...
	public int getBodyLength() {
		int bodyLength = 0;
		for(ReportResponse r : ReportResponse.values()) {
