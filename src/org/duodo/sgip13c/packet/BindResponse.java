 ...
 *
 */
public  enum BindResponse implements PacketStructure {
    ...
    private BindResponse(SgipDataType dataType, boolean isFixFiledLength, int length) {
    	this.length = length;
	...
	public int getBodyLength() {
		int bodyLength = 0;
		for(BindResponse r : BindResponse.values()) {
